  ...
  return (
    <div className="rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm p-5">
      <div className="flex items-center justify-between mb-5">
        <div>
          <h3 className="text-sm font-semibold text-white">MRR &amp; Revenue Trend</h3>
          <p className="text-xs text-gray-400 mt-0.5">Monthly recurring revenue vs total revenue</p>
        </div>
